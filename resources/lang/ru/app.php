...
return [
    ...
    */
    ...
    'title' => 'Заголовок',
    'size' => 'Размер',
    'possible_create_list' => 'Возможность создать',
    'plan' => 'План',
    'edit' => 'Редактировать',
    'remove' => 'Удалить',
    'create_list' => 'Создать лист',
    'item' => 'пункт',
    'edit_list' => 'Редактировать лист',
    ...
    'measure_seven_lang' => 'Отредактировать лист',
    'cleaner_lang' => 'Удалить 10 листов',
    'scheduler_lang' => 'Создать 10 листов',
    'lock' => 'Закрыт',
];
